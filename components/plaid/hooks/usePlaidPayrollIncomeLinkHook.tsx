...
export default function usePlaidPayrollIncomeLinkHook(shouldRefresh: boolean): PlaidHookReturn
{
    ...
    const createLinkToken = async () => {
        try {
            ...
            const newLinkToken = await PlaidService.createPlaidLinkTokenForPayrollIncome(accessToken);
        ...
        {
            console.error('usePlaidPayrollIncomeLinkHook: createLinkToken: error', error);
    ...
    const initPlaidLink = async (linkToken: string) => {
        ...
        {
            console.error('usePlaidPayrollIncomeLinkHook: initPlaidLink: error', error);
    ...
    const handlePlaidSuccess = async (success: LinkSuccess) => {
        ...
        {
            console.error('usePlaidPayrollIncomeLinkHook: handlePlaidSuccess: error:', error);
        } 
        finally 
        {
            setLinkToken(null);
